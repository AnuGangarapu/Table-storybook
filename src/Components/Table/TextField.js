...
const useStyles = makeStyles((theme) => ({
  ...
  root: {
    ...
    borderRadius: "4px",
    width: (styles) => styles?.width ? styles?.width: '320px',
...
const TextFields = (props) => {
  ...
  const { size,variant, placeholder, mandatory, iconType, helperText, showEndAdornment, showStartAdornment, isDisabled,disableLine,isNormalField ,style,value,name,id,className} = props
  ...
  const handleChange = event => {
    ...
    props.handledata(name,event.target.value)
